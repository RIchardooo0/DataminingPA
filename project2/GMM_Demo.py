...
b = 0.0000001
while (np.linalg.norm(new_pi - old_pi) > b or np.linalg.norm(new_covs - old_covs) > b or np.linalg.norm(
        new_means - old_means) > b):
...
principalDF = pd.DataFrame(data=my_data, columns=['principal component 1', 'principal component 2'])
